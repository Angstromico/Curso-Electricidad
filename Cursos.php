    ...
    <main class="contenedor">
        ...
        <div class="curso">
            <div class="curso__img">
                <img loading="lazy" src="img/instrumentation-engineer-getreskilled.jpg" alt="Diagramas Electricos">
            </div>
        ...
        <div class="curso">
             <div class="curso__img">
                <img loading="lazy" src="img/ece-master.jpg" alt="Instrumentación Electrica">
             </div>
             <div class="curso__información">
             <p class="widget--curso__label">Precio: <span class="widget--curso__info">Gratis</span></p>
             <p class="widget--curso__label">Cupos: <span class="widget--curso__info">50</span></p>
        ...
        <div class="curso"> 
             <div class="curso__img">
                <img  loading="lazy" src="img/feature-article-electrical-and-electronics-engineering-whats-the-difference-838x484-2019.png" alt="Instrumentación Industrial">
            </div>
            <div class="curso__información">
            <p class="widget--curso__label">Precio: <span class="widget--curso__info">Gratis</span></p>
            <p class="widget--curso__label">Cupos: <span class="widget--curso__info">50</span></p>
        ...
        <div class="curso"> 
             <div class="curso__img">
                <img loading="lazy" src="img/monkimage.jpeg" alt="Sistemas Digitales">
            </div>
            <div class="curso__información">
            <p class="widget--curso__label">Precio: <span class="widget--curso__info">Gratis</span></p>
            <p class="widget--curso__label">Cupos: <span class="widget--curso__info">50</span></p>
